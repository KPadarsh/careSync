...
export function PatientShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col md:flex-row">
      ...
      {/* Mobile Bottom Navigation Bar (Stitch Reference) */}
      <nav
      ...
      >
        <Link
          href="/patient"
          className="flex flex-col items-center justify-center py-1 px-3 rounded-lg text-primary font-bold text-[11px]"
        >
        ...
        <Link
          href="#appointments"
          className="flex flex-col items-center justify-center py-1 px-3 rounded-lg text-muted-foreground hover:text-foreground text-[11px]"
        >
          <svg className="h-5 w-5 mb-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
