...
export const StethoscopeIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const QueueIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const PatientsIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const ConsultationIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const LabIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const PrescriptionsIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const RecordsIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const FollowUpsIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const ArrowForwardIcon = ({ className = "w-4 h-4", size }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const ArrowBackIcon = ({ className = "w-4 h-4", size }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const HeartPulseIcon = ({ className = "w-4 h-4", size }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const IconStethoscope = StethoscopeIcon;
...
export const IconArrowRight = ArrowForwardIcon;
export const IconX = CloseIcon;
export const IconBell = NotificationsIcon;
...
export const IconBuilding = BuildingIcon;
